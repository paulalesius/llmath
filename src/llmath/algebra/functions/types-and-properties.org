...
* R Examples and Plots
  #+BEGIN_SRC R :results output graphics :file linear_function_plot.png
    library(ggplot2)
    x <- seq(-10, 10, by = 0.1)
    y <- 2 * x + 3
  ...
  #+BEGIN_SRC R :results output graphics :file quadratic_function_plot.png
    y <- x^2 - 4*x + 4
  ...
  #+BEGIN_SRC R :results output graphics :file exponential_function_plot.png
    y <- 2 * 3^x
  ...
  [[file:exponential_function_plot.png]]
